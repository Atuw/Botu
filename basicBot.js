...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://atuw.org/botuw/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "Botu",
        loggedInID: 5236185,
        scriptLink: "https://atuw.org/botuw/basicBot.js",
        cmdLink: "https://atuw.org/botuw/commands.md",
        ...
        settings: {
            ...
            motdEnabled: true,
            motdInterval: 5,
            motd: "Hey welcome to our room! Make sure to check out our rules here: http://www.evenburgers.com/img/Drawings/RuleList.png",
            filterChat: true,
			...
			blowjobCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            API.sendChat(basicBot.chat.autofellatio);
                            return false;
                        }
                        else {
                            ...
                            if (user === false || !user.inRoom) {
                                return API.sendChat(subChat(basicBot.chat.nouserblowjob, {name: name}));
                            }
                            else if (chat.uid === basicBot.loggedInID) {
							    return API.sendChat(subChat(basicBot.chat.botjob, {name: name}));
							}
                                else {
                                    return API.sendChat(subChat(basicBot.chat.blowjob, {nameto: user.username, namefrom: chat.un, blowjob: this.getBlowjob()}));
                            }
                        }
                    }
                }
            ...
            emojiCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = 'https://www.emoji-cheat-sheet.com/';
                        ...
                        for (var i = 0; i < len; ++i){
                            if (users[i].username == name){
                                ...
                                if (typeof slug !== 'undefined') {
                                    var profile = ", Profile: https://plug.dj/@/" + slug;
                                } else {
                                    var profile = "";
                                }
